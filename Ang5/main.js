...
var routes = [
    {
        path: "features",
        component: _features_features_component__WEBPACK_IMPORTED_MODULE_6__["FeaturesComponent"]
    },
    {
        path: "pricing",
        component: _pricing_pricing_component__WEBPACK_IMPORTED_MODULE_7__["PricingComponent"]
    },
    {
        path: "posts",
        component: _posts_posts_component__WEBPACK_IMPORTED_MODULE_9__["PostsComponent"]
    },
    {
        path: "posts/:id",
...
module.exports = "<h2 [class]=\"cls\" >\n  Welcome {{name}}\n</h2>\n<br/>\n<input type=\"text\" [(ngModel)]=\"name\" [placeholder]=\"defaultPlaceHoder\" >\n<br/>\n<p>You Click {{ times }} Times</p>\n<br/>\n<p><button (click)=\"IncreaseNumber()\">Click Me!</button></p>\n<p *ngIf=\"show\">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut maiores placeat illo sint voluptatum velit optio rerum quidem tempora commodi officiis, recusandae quia adipisci aperiam maxime. Quam mollitia incidunt saepe.</p>\n\n<p *ngIf=\"show; then tb else eb\"></p>\n<ng-template #tb>\n  <h2>Then Block Excuted........</h2>\n</ng-template>\n<ng-template #eb>\n  <h2>Else Block Excuted......</h2>  \n</ng-template>\n<p><button (click)=\"ChangeBlock()\">{{ show ? 'Hide' : 'Show' }}</button></p>\n\n<p [ngClass]=\"[cls,cls2]\">Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat quasi aut, fugit tempore officia iusto similique magnam neque earum cupiditate vero. Quidem vero possimus quae praesentium doloribus earum, incidunt et.</p>\n\n<p [ngClass]=\"colors\">Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat quasi aut, fugit tempore officia iusto similique magnam neque earum cupiditate vero. Quidem vero possimus quae praesentium doloribus earum, incidunt et.</p>\n\n<p [ngStyle]=\"inlineColor\">Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat quasi aut, fugit tempore officia iusto similique magnam neque earum cupiditate vero. Quidem vero possimus quae praesentium doloribus earum, incidunt et.</p>\n\n<p [ngStyle]=\"{'color':fcolor, 'font-size.px':size}\">Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat quasi aut, fugit tempore officia iusto similique magnam neque earum cupiditate vero. Quidem vero possimus quae praesentium doloribus earum, incidunt et.</p>\n\n<p>\n  <input type=\"radio\" name=\"color\" id=\"\" (change)=\"Changecolor('red')\">Red <br>\n  <input type=\"radio\" name=\"color\" id=\"\" (change)=\"Changecolor('green')\">Green <br>\n  <input type=\"radio\" name=\"color\" id=\"\" (change)=\"Changecolor('blue')\">Blue <br>\n  <input type=\"number\" name=\"\" id=\"\" [(ngModel)]=\"size\">\n</p>\n<p>\n  <input type=\"number\" name=\"\" id=\"\" [(ngModel)]=\"showView\">\n</p>\n<div [ngSwitch]=\"showView\">\n  <p *ngSwitchCase=\"1\">This is Block one</p>\n  <p *ngSwitchCase=\"2\">This is Block Two</p>\n  <p *ngSwitchCase=\"3\">This is Block Three</p>\n  <p *ngSwitchDefault>This is Default Block</p>\n</div>"
...
var TestComponent = /** @class */ (function () {
    function TestComponent() {
        this.fcolor = "";
        this.name = "Nirankesh Chourasiya";
        this.cls = "colorRed";
        this.cls2 = "colorGreen";
        this.cls3 = "colorBlue";
        this.defaultValue = "test";
        this.defaultPlaceHoder = "Enter Value";
        this.times = 0;
        this.show = false;
        /*colors = [
    ...
    TestComponent.prototype.IncreaseNumber = function () {
        this.times++;
    };
    TestComponent.prototype.ChangeBlock = function () {
        this.show = !this.show;
    };
    TestComponent.prototype.Changecolor = function (val) {
        this.fcolor = val;
    };
...
module.exports = __webpack_require__(/*! c:\xampp\htdocs\angular-5\Ang5\src\main.ts */"./src/main.ts");
